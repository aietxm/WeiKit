...
MEM_OPTS="-Xms16384M -Xmx16384M -Xmn6554M"
...
GC_OPTS="$GC_OPTS -XX:MaxTenuringThreshold=15"
...
#开放JMX本地访问，设定端口号
JMX_OPTS="-Djava.rmi.server.hostname=10.23.6.85 -Dcom.sun.management.jmxremote.port=7001 -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false"
...
echo JAVA_OPTS="$MEM_OPTS $GC_OPTS $GCLOG_OPTS $OPTIMIZE_OPTS $SHOOTING_OPTS $JMX_OPTS $OTHER_OPTS"
